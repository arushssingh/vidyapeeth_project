...
import 'attendancelist_model.dart';
export 'attendancelist_model.dart';

class AttendancelistWidget extends StatefulWidget {
  const AttendancelistWidget({super.key});

  static String routeName = 'attendancelist';
  static String routePath = '/attendancelist';
...
class _AttendancelistWidgetState extends State<AttendancelistWidget> {
  late AttendancelistModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AttendancelistModel());
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        if (_model.textController.text != '') {
                          FFAppState()
                              .addToTodoList(_model.textController.text);
                          safeSetState(() {});
                          safeSetState(() {
            ...
            Column(
              ...
              children: [
                Padding(
                  ...
                  child: Builder(
                    builder: (context) {
                      final todo = FFAppState().todoList.toList();
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: RadiobuttonWidget(
                                        key: Key(
                                            'Keyupp_${todoIndex}_of_${todo.length}'),
                                      ),
                                    ),
                                  ],
                                ),
