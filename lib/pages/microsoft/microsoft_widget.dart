...
class MicrosoftWidget extends StatefulWidget {
  ...
  static String routeName = 'microsoft';
  static String routePath = '/microsoft';

  @override
  State<MicrosoftWidget> createState() => _MicrosoftWidgetState();
}
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              FlutterFlowWebView(
                content: 'https://careers.microsoft.com/v2/global/en/students',
                bypass: false,
                height: 736.6,
